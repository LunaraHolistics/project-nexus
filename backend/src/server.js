...
app.get("/api/health", async (req, res) => {
  ...
  // ============================================
  // ROTA RAIZ (para não confundir quem acessa)
  // ============================================
  app.get("/", (req, res) => {
    res.json({
      message: "🏛️ Bem-vindo ao ARCHIVE OS API",
      status: "online",
      version: "3.0.0",
      frontend: "https://project-nexus-mi7.netlify.app",
      endpoints: {
        health: "/api/health",
      ...
      quote: '"A história é uma teia, e nós somos os observadores."',
      requestId: req.id,
    });
  });
